...
void lab1()
{
	...
	// zapis wynikow do pliku
	std::ofstream file(R"(C:\Users\Ania\CLionProjects\Optymalizacja\Optymalizacja\lab1-analiza\lab1-symulation-fib.txt)"); //musialam dac cala sciezke bo nie dzialalo xd
	if (file.is_open()) {
